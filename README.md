...
4. **各個Client的Version增加顯示Maximum Active Tours (當roleType=6時，判斷IsActiveShareable==true時使用user.Parent.ActiveCount，否的話用user.ActiveCount，當RoleType為其他時採用user.ActiveCount)，並放在第一列**
